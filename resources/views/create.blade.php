...
<div class="container my-5">
    ...
    <form action="{{ route('tasks.store') }}" method="POST">
        ...
        <div id="tasks-wrapper">
            <div class="task-item border rounded-3 p-3 mb-3 shadow-sm">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" name="tasks[0][due_date]" class="form-control form-control-lg" required>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="d-flex justify-content-between mt-4">
            <button type="button" id="add-task" class="btn btn-primary btn-lg">
